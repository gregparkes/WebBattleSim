...
const BATTLE_TEMPLATE = {
    // default templates
    OPPOSITE_AGGRESSIVE: function(canvas, n1=20, n2=25) {
        let w = canvas.width,
            h = canvas.height;
        let g1 = unit_group.make_gaussian(CloneTrooper, n1, w * .25, 300,
            ...
            units = g1.concat(g2);
        return battle(canvas, units);
    },
    SNIPERS_NEST: function(canvas, n1=20, n2=25) {
    ...
    JEDI_DEFENDERS: function(canvas, n1, n2) {
        let w = canvas.width,
            h = canvas.height;
    ...
    GUERRILLA_WARFARE: function(canvas, n1=20, n2=25) {
        let w = canvas.width,
            h = canvas.height;
        let g2 = unit_group.make_gaussian(B1Battledroid, 50, w * .5, w * .5 + 50,
                h * .5, h * .5 + 50, AI.aggressive),
    ...
    TOWER_DEFENCE: function(canvas, n1=20, n2=25) {
        let w = canvas.width,
            h = canvas.height;
        let g1 = unit_group.make_gaussian(B1Battledroid, 50, w * .5, w * .5 + 50,
            ...
            objs = g1.concat(g2, t);
        return battle(canvas, objs);
    },
    OVERWHELMING_ODDS: function(canvas, n1=20, n2=5) {
        let w = canvas.width,
            h = canvas.height;
    ...
    OBSTACLE_NAVIGATION: function(canvas, n1=10, n2=5) {
        let w = canvas.width,
            h = canvas.height;

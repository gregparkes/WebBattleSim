...
(function(definition) {
    ...
    function Graph2(gridIn, options) {
        ...
        this.grid = [];
        // make a 1d grid
        this.width = gridIn.length;
        // assumes all elements in gridIn are same length.
        this.height = gridIn[0].length;
    ...
    function Graph(width, height, options) {
    ...
    Graph.prototype.addNode = function(x, y, value) {
        let node = new GridNode(x, y, value);
        this.grid[y*this.width + x] = node;
        this.nodes.push(node);
    };
    ...
    /*
    Graph.prototype.neighbors2 = function(node) {
    ...
    /*
    Graph.prototype.toString2 = function() {
        let graphString = [];
        let nodes = this.grid;
    ...
    Graph.prototype.toString = function() {
        ...
        for (let y = 0; y < this.height; y++) {
            ...
            for (let x = 0; x < this.width; x++) {
                rowDebug.push(nodes[y*this.width + x].weight);
            }
            graphString.push(rowDebug.join(" "));
        }
        return graphString.join("\n");
